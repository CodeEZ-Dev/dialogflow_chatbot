CREATE DATABASE  IF NOT EXISTS `car_accessories` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `car_accessories`;
...
--
-- Table structure for table `accessories_item`
--

DROP TABLE IF EXISTS `accessories_items`;
...
--
-- Dumping data for table `accessories-item`
--

LOCK TABLES `accessories_items` WRITE;
/*!40000 ALTER TABLE `accessories_items` DISABLE KEYS */;
INSERT INTO `accessories_items` VALUES (1,'Dash Cam',6.00),(2,'Car Cover',7.00),(3,'Roof Rack',8.00),(4,'Car Organizer',5.00),(5,'LED Headlights',6.00),(6,'Windshield Sunshade',9.00),(7,'Car Air Purifier',4.00),(8,'Backup Camera',7.00),(9,'Car Alarm System',5.00);
/*!40000 ALTER TABLE `accessories_items` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `accessories_items` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    ...
    -- Check if the item_name exists in the accessories_item table
    IF (SELECT COUNT(*) FROM accessories_items WHERE name = p_item_name) > 0 THEN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_order_item`(
  IN p_accessories_item VARCHAR(255),
  IN p_quantity INT,
  IN p_order_id INT
)
BEGIN
    ...
    -- Get the item_id and price for the accessories item
    SET v_item_id = (SELECT item_id FROM accessories_items WHERE name = p_accessories_item);
    SET v_price = (SELECT get_price_for_item(p_accessories_item));
